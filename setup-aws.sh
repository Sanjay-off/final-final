...
# ============================================================================
# TELEGRAM BOT SYSTEM - AUTOMATED SETUP SCRIPT
...
print_header "TELEGRAM BOT SYSTEM - AUTOMATED SETUP"
...
print_info "Installing Python, Git, and development tools..."
...
# ============================================================================
print_header "Step 7: Nginx Configuration (Optional)"
...
print_success "Telegram Bot System setup completed successfully!"
...
echo "1. Make sure you've configured .env file with your actual values"
...
echo ""
print_info "Your verification server is running on port 5000"
print_info "Access it locally at: http://localhost:5000/health"

if [ ! -z "$DOMAIN_NAME" ]; then
    print_info "Access it via domain at: https://$DOMAIN_NAME/health"
fi
